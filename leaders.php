  ...
  <!-- <div class="container">
    <div class="row">
      ...
      <div class="grid_4">
        ...
        <div class="extra_wrapper">
          <p class="fwn"><a href="#">Connect Jobseeker to Job</a></p>
          <p class="offset__1"></p>
        </div>
          Use advance algorithum and mobile app to find and evaluate candidate.
      </div>
      <div class="grid_4">
